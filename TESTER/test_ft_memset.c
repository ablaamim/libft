...
int	main(void)
{
	...
	ptr_str0 = memset(str0, '.', 5);
	ptr_str1 = ft_memset(str1, '.', 5);
	//printf("str0 -> %s\nstr1 -> %s\n", str0, str1);
	//printf("ptr_str0 -> %s\nptr_str1 -> %s\n", ptr_str0, ptr_str1);
	...
	ptr_str2 = ft_memset(str2, '.', 3);
	ptr_str3 = memset(str3, '.', 3);
	//printf("str2 -> %s\nstr3 -> %s\n", str2, str3);
	//printf("ptr_str2 -> %s\nptr_str3 -> %s\n", ptr_str2, ptr_str3);
	...
	index =0;
	ptr_arr0 = memset(arr0, 1, 3*sizeof(*arr0));
	ptr_arr1 = ft_memset(arr1, 1, 3*sizeof(*arr1));
	while (index < 5)
	{
		// printf("arr0[%d] -> %d\narr1[%d] -> %d\n", \
		// 		index, arr0[index], \
